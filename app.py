...
""".format(otp)
    ...
    server.login('vs154520@gmail.com', 'bpvi wkud gczv kefe')
...
def send_new_course_email( email_content):
    email_address = 'vs154520@gmail.com'  # Your Gmail email address
    app_password = 'bpvi wkud gczv kefe'  # Your app-specific password
